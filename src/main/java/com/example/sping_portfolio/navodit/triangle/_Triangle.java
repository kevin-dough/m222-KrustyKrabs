...
public abstract class _Triangle {
    int size;
    String name;
    int hashID;
    ...
    public void print() {
        ...
        ConsoleMethods.println("Triangle Number " + this.size + " = " + this.getNth());
        ConsoleMethods.println("Triangle List = " + this.getList());
        ConsoleMethods.println("Triangle Hashmap = " + this.getHash());
        for (int i=0 ; i<this.size; i++ ) {
            ConsoleMethods.println("Triangle Sequence " + (i+1) + " = " + this.getNthSeq(i));
        }
    }
    ...
    public static void main(String[] args) {
        TrigFor.main(null);
        TrigRecurse.main(null);
        TrigStream.main(null);
        TrigWhile.main(null);
    }
}
